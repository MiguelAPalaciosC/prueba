...
$('#btnEditar').click(function() {
    ...
    if (filaValida !== '' && filaValida !== null && filaValida !== undefined) {
        ...
        if (filaSeleccionada.length > 0) { // Verifica que haya una fila seleccionada
            const id_practica = filaSeleccionada.data("valor"); // Obtener el valor del atributo data-valor
            ...
            console.log(id_practica);
            console.log(codigo);
            console.log(descripcion);

            $('#id_practica').val(id_practica);
            $('#codigo_practica').val(codigo);
            $('#descripcion_practica').val(descripcion);
