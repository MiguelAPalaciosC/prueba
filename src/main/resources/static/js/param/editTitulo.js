...
$('#btnEditar').click(function() {
    ...
    if (filaValida !== '' && filaValida !== null && filaValida !== undefined) {
        ...
        if (filaSeleccionada.length > 0) { // Verifica que haya una fila seleccionada
            const id_titulo = filaSeleccionada.data("valor"); // Obtener el valor del atributo data-valor
            ...
            $('#id_titulo').val(id_titulo);
            $('#codigo_titulo').val(codigo);
            $('#descripcion_titulo').val(descripcion);
